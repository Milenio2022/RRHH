...
<ol class="breadcrumb" style="margin: 10px 0px ! important;">
    <li class="breadcrumb-item"><a href="Home.php">Inicio</a><i class="fa fa-angle-right"></i>Empleado<i class="fa fa-angle-right"></i>Vista de Emplead@</li>
</ol>
        ...
        <div>
            <div class="w3l-table-info">
                ...
                <table id="table">
                    <thead>
                        <tr>
                            <th style="text-transform: capitalize;">Foto de Perfil</th>
                            <th style="text-transform: capitalize;">Nombre</th>
                            <th style="text-transform: capitalize; text-align: center;">ID empleado</th>
                            <th style="text-transform: capitalize; text-align: center;">Información</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($sql)) { ?>
                            <tr>
                                <td style="width: 140px;"><img id="myImg" alt="<?php $fname = (isset($row['FirstName'])) ? $row['FirstName'] : "";
                                ...
                                <td><?php $fname = (isset($row['FirstName'])) ? $row['FirstName'] : "";
                                    $mname = (isset($row['MiddleName'])) ? $row['MiddleName'] : "";
                                    $lname = (isset($row['LastName'])) ? $row['LastName'] : "";
                                    echo ucfirst($fname) . "&nbsp;" . $mname . "&nbsp;" . $lname; ?></td>

                                <td style="width: 105px;"><?php $emp = (isset($row['EmployeeId'])) ? $row['EmployeeId'] : "";
                                                            echo ucfirst("<center>" . $emp . "</center>"); ?></td>
                                <td style="text-align: center;"><a href="detailview.php?employeeid=<?php echo $row['EmpId']; ?>"><u>Ver</u></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
