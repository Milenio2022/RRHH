            ...
            <div class="mother-grid-inner">
                ...
                <div class="header-main">
                    <div style="padding: 1.15em; margin-right: 0%; width: 70%;" class="logo-w3-agile">
                        <h1 clas><a href="home.php">Recursos Humanos ConfiguroWeb</a></h1>
                    </div>
                        ...
                        <ul>
                            <li class="dropdown profile_details_drop">
                                ...
                                <ul class="dropdown-menu drp-mnu">
                                    ...
                                    <li> <a href="controller/logout.php"><i class="fa fa-sign-out"></i> Cerrar Sesión</a> </li>
                                </ul>
                            </li>
                        </ul>
                    </div>
